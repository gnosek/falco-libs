...
TEST_F(sinsp_with_test_input, execveat_empty_path_flag) {
	...
	ASSERT_STREQ(evt->get_thread_info()->m_exepath.lock()->c_str(), file_to_run);
...
TEST_F(sinsp_with_test_input, execveat_relative_path) {
	 ...
	 */
	ASSERT_NE(evt->get_thread_info(), nullptr);
	ASSERT_STREQ(evt->get_thread_info()->m_exepath.lock()->c_str(), "/tmp/dir/file");
...
TEST_F(sinsp_with_test_input, execveat_invalid_path) {
	 ...
	 */
	ASSERT_NE(evt->get_thread_info(), nullptr);
	ASSERT_STREQ(evt->get_thread_info()->m_exepath.lock()->c_str(), "<NA>");
...
TEST_F(sinsp_with_test_input, execveat_absolute_path) {
	 ...
	 */
	ASSERT_NE(evt->get_thread_info(), nullptr);
	ASSERT_STREQ(evt->get_thread_info()->m_exepath.lock()->c_str(), "/tmp/file");
...
TEST_F(sinsp_with_test_input, execveat_relative_path_s390) {
	...
	ASSERT_NE(evt->get_thread_info(), nullptr);
	ASSERT_STREQ(evt->get_thread_info()->m_exepath.lock()->c_str(), "/tmp/s390x/dir/file");
...
TEST_F(sinsp_with_test_input, execveat_absolute_path_s390) {
	 ...
	 */
	ASSERT_NE(evt->get_thread_info(), nullptr);
	ASSERT_STREQ(evt->get_thread_info()->m_exepath.lock()->c_str(), "/tmp/s390/file");
